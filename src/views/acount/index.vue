<template>
  <el-card>
    ...
    <el-form class="formdata" style="padding: 40px;" :model="formData" :rules="rules" ref="myform">
      ...
      <el-form-item label="登陆方式" style="border-bottom:1px solid #ccc;padding-bottom:20px">
        ...
        <el-input style="width:300px;margin-left:30px" placeholder="电话号码" disabled v-model="formData.mobile"></el-input>
      </el-form-item>
  ...
  data () {
    return {
      ...
      rules: {
        ...
        { patter: /^([a-zA-Z]|[0-9])(\w|-)+@[a-zA-Z0-9]+\.([a-zA-Z]{2,4})$/, message: '您输入的格式不正确' }
        ]
      }
    }
  },
